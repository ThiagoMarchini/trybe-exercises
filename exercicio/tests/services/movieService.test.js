...
describe('Testa o Service', () => {
  ...
  describe('Busca um filme, por id, no BD', () => {
    describe('quando existe o filme com o id', () => {
      before(() => {
    ...
    describe('quando não existe o filme com o id', () => {
      before(() => {
        sinon.stub(MoviesModel, 'getById')
          .resolves(null);
      });
      ...
      it('retorna nulo', async() => {
        const id = '604cb554311d68f491ba57aa';
        const movie = await MoviesService.getById(id);
